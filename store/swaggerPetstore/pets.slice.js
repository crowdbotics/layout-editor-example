...
export const findPetsByTags = createAsyncThunk(
  "pets/findPetsByTags",
  async payload => await apiService.findPetsByTags(payload)
)
export const getPetById = createAsyncThunk(
  "pets/getPetById",
  async payload => await apiService.getPetById(payload)
)
export const updatePetWithForm = createAsyncThunk(
  "pets/updatePetWithForm",
  async payload => await apiService.updatePetWithForm(payload)
)
export const deletePet = createAsyncThunk(
  "pets/deletePet",
  async payload => await apiService.deletePet(payload)
)
