...
function updatePetWithForm(payload) {
  return swaggerPetstore.post(`/pet/${payload.petId}`, { data: payload.data })
}
function deletePet(payload) {
  return swaggerPetstore.delete(`/pet/${payload.petId}`)
}
function uploadFile(payload) {
  return swaggerPetstore.post(`/pet/${payload.petId}/uploadImage`, {
    data: payload.data
  })
}
...
function updateUser(payload) {
  return swaggerPetstore.put(`/user/${payload.username}`, {
    data: payload.data
  })
}
